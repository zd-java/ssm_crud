...
%> 
<!-- web路径：
不以 / 开始的路径，找资源，以当前的资源的路径基准，经常容易出问题。
...
<body>
	      ...
	      <div class="modal-body">
        	<form class="form-horizontal">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="email" class="form-control" id="email_update_input" placeholder="email@zd.com">
	      ...
	      <div class="modal-body">
        	<form class="form-horizontal">
			  ...
			  <div class="form-group">
			    <label class="col-sm-2 control-label">email</label>
			    <div class="col-sm-10">
			      <input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@zd.com">
	    		  <span class="help-block"></span>
			    </div>
			  </div>
			  <div class="form-group">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h1 class="btn btn-success btn-lg">SSM_CRUD</h1>
			</div>
		</div>
		<!-- 按钮 -->
		<div class="row">
	...
	<script type="text/javascript">
		...
		function build_page_info(result) {
			...
			//给要显示的数据加上背景颜色
			var span_pageInfo1 = $("<span></span>").addClass("label label-default");
			var span_pageInfo2 = $("<span></span>").addClass("label label-default");
			var span_pageInfo3 = $("<span></span>").addClass("label label-default");
			$("#page_info_area").append("当前第").append(span_pageInfo1.append(result.extend.pageInfo.pageNum))
								.append("页,总共").append(span_pageInfo2.append(result.extend.pageInfo.pages))
								.append("页,共").append(span_pageInfo3.append(result.extend.pageInfo.total))
								.append("条记录");
			//记录总记录数和当前页
		...
		$("#emp_add_modal_btn").click(function() {
			//清除表单数据(表单完整重置(包括表单的数据和样式))(老师的做法)
			reset_form("#empAddModal form");
			
			//清空新增信息(我的做法(老师讲之前)，本来想着做完之后再抽取出来，没想到已经有封装好的)
		...
		function validate_add_from() {
			...
			if(!regName.test(empName)) {
				//alert("用户名可以是2-5位的中文或者6-16位的英文、数字、下划线和中横线组合");
				show_validate("#empName_add_input","error","用户名可以是2-5位的中文或者6-16位的英文、数字、下划线和中横线组合");
				return false;
			}else {
		...
		$("#check_all").click(function() {
			...
			//我们这些dom原生的属性用prop来读取和修改；attr获取自定义属性的值
